...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 class="text-center">Student Registration (Coaching)</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<form:form action="saveStudentCoaching${_csrf.parameterName}=${_csrf.token}" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="radio-inline">
								<form:radiobutton path="board" value="Federal"/>Federal
							</div>
							<div class="radio-inline">
								<form:radiobutton path="board" value="Rawalpindi"/>Rawalpindi
							</div>
						</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="acCharges">A.C Charges</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="balance"> Balance Amount</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="balanceDueDate">Balance Date</label>
						<div class="col-sm-4" onclick="aaa();">
